    ...
    function executeAllocation(uint256 dollarUnits) private returns (uint256) {
        ...
        if (round == 2) {
            require(
                ...
                "BCubePublicSale: wait for second round to start"
            );
        }
        require(
            dollarUnits >= minContributionDollarUnits,
            "BCubePublicSale: Min contrbn $500 not reached."
        );
        require(
            dollarUnits <= maxContributionDollarUnits,
            "BCubePublicSale: Exceeds max contrbn $2500 limit"
        );
        ...
        require(
            ...
            "BCubePublicSale: Exceeds total max contribn $10000"
        );
        ...
        require(netSoldBcube <= HARD_CAP, "BCubePublicSale: Exceeds hard cap");
