...
describe("Treasury tests without private sale", async function () {
  ...
  const allocations = {
    ...
    'investor3': {
      private: new BigNumber('900000').times(new BigNumber('1e18')),
    ...
    'investor5': {
      private: new BigNumber('100000').times(new BigNumber('1e18')),
      public: new BigNumber('150000').times(new BigNumber('1e18')),
  ...
  before(async function () {
    ...
    await investInUSDT(investor5, 45000);
  ...
  it("validate calcAllowance for investor5", async function () {
    ...
    for (let week = 0; week <= 15; week++) {
      ...
      switch(week) {
        case 0:
          expect(allowance).to.be.equal('37500', `Invalid allowance for week ${week}`);
          break;
        case 1:
          expect(allowance).to.be.equal('75000', `Invalid allowance for week ${week}`);
          break;
        case 2:
          expect(allowance).to.be.equal('112500', `Invalid allowance for week ${week}`);
          break;
        case 3:
          expect(allowance).to.be.equal('150000', `Invalid allowance for week ${week}`);
          break;
        case 4:
          expect(allowance).to.be.equal('187500', `Invalid allowance for week ${week}`);
          break;
        case 5:
          expect(allowance).to.be.equal('225000', `Invalid allowance for week ${week}`);
          break;
        case 6:
          expect(allowance).to.be.equal('262500', `Invalid allowance for week ${week}`);
          break;
        case 7:
          expect(allowance).to.be.equal('300000', `Invalid allowance for week ${week}`);
          break;
        case 8:
          expect(allowance).to.be.equal('337500', `Invalid allowance for week ${week}`);
          break;
        case 9:
          expect(allowance).to.be.equal('375000', `Invalid allowance for week ${week}`);
          break;
        case 10:
          expect(allowance).to.be.equal('412500', `Invalid allowance for week ${week}`);
          break;
        case 11:
          expect(allowance).to.be.equal('450000', `Invalid allowance for week ${week}`);
          break;
        case 12:
          expect(allowance).to.be.equal('475000', `Invalid allowance for week ${week}`);
          break;
        case 13:
          expect(allowance).to.be.equal('500000', `Invalid allowance for week ${week}`);
          break;
        case 14:
          expect(allowance).to.be.equal('525000', `Invalid allowance for week ${week}`);
          break;
        case 15:
          expect(allowance).to.be.equal('550000', `Invalid allowance for week ${week}`);
          break;
      }
    }
  });
  ...
  it("allows 3 to withdraw 100% of tokens after vesting period", async function () {
    ...
    expect(bal.toFixed(0)).to.equal('1200000');
  });
